...
echo "- Install and configure fprintd for fingerprint reading. See"
echo "  Arch Wiki for details on fprintd setup."
echo "- Enable tap to click in /usr/share/X11/xorg.conf.d/40-libinput.conf"
echo "  By adding: Option \"Tapping\" \"True\" in the touchpad section."
echo "- Configure default network for VM."
echo "############################################################"
